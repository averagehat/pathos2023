...
AssemblerListener* AssemblerListener::makeNullListener(){ return new AssemblerListenerNull(); }
AssemblerListener* AssemblerListener::makeStdListener(){ return new AssemblerListenerStd(); }
AssemblerListener* AssemblerListener::makeVerboseListener(){ return new AssemblerListenerVerbose(); }
AssemblerListener* AssemblerListener::makeVerboseListenerFile(string filename){
  return new AssemblerListenerVerbose(filename);
}
