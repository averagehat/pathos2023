...
#ifndef WRITABLESEQFASTA_H
#define WRITABLESEQFASTA_H

#include "WritableSeq.h"
#include "AssemblyException.h"
#include "ReadFileFastaSingle.h"

class WritableSeqFasta : public WritableSeq {
 public:
  // the third line of fastq entries is not required
  WritableSeqFasta(string nameLine, vector<string>* seqLines);
  void OK();
  ~WritableSeqFasta();
 ...
 private:
  char* _seq;
  long _size;
  // some positions are zeroed in the constructor
  float* _scores;
  char* _rcSeq;
  char* _nameLine;
  long _nameSize;
