...
void ReadFilePaired::splitFile(set<ReadFile*>* putFilesHere, long numFiles){
...
void ReadFilePaired::openWithCarriers(long numSets){
  open();
  _openWithCarriers = true;
  _numCarrierSets = numSets;
}
void ReadFilePaired::openWithCarriers(long numSets, bool getBothEnds){
...
void ReadFilePaired::openNormWithCarriers(long numSets){
  open();
  _openWithCarriers = true;
  _numCarrierSets = numSets;
  _openNormalized = true;
}
void ReadFilePaired::openNormWithCarriers(long numSets, bool getBothEnds){
