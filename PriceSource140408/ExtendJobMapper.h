...
class ExtendJobMapper {
 public:
  ...
  static long readToLong(char* seq, long length);
};
...
class ExtendJobMapperWithLinks : public ExtendJobMapper {
 ...
 private:
  ...
  // for an alternative mapPairedQueries that doesn't collapse redundancy
  void mapQueriesHelper(vector<Alignment*>* matchesArray, ScoredSeqWithCarriers** queries,
