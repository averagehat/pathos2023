...
class ReadFilePriceqSingle : public ReadFile {
  ...
  */
  ReadFilePriceqSingle(string filename, long readStart, long readLength);
  ReadFilePriceqSingle(bool invert, string filename, long readStart, long readLength);
 ...
 private:
  ...
  void gatherRawDataForBufferReads(long numReads, ReadFileIndex** rfiArray, char** readData, char** scoreData, char** linkData);

  ScoredSeq* bufferFillInterpretHelper(char* rawSeqArray, char* rawScoresArray, char* rawLinksArray, ReadFileIndex* rfi);


  // private constructor for making subset files
  ReadFilePriceqSingle(ReadFilePriceqSingle* precursor, long intialBlock, long initialPos, long numReads, bool numReadsDetermined);
  ...
  public:
    ...
    ReadFileIndex3start1len(long readStart, long scoreStart, long linkStart, long readSize, long blockNum);
