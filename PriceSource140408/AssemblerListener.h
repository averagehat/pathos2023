...
class AssemblerListener {
 ...
 public:
  static AssemblerListener* makeNullListener();
  static AssemblerListener* makeStdListener();
  static AssemblerListener* makeVerboseListener();
  static AssemblerListener* makeVerboseListenerFile(string filename);
