...
void ReadFileDual::splitFile(set<ReadFile*>* putFilesHere, long numFiles){
...
void ReadFileDual::openWithCarriers(long numSets){
  open();
  _openWithCarriers = true;
  _numCarrierSets = numSets;
}
void ReadFileDual::openWithCarriers(long numSets, bool getBothEnds){
...
void ReadFileDual::openNormWithCarriers(long numSets){
  open();
  _openWithCarriers = true;
  _numCarrierSets = numSets;
  _openNormalized = true;
}
void ReadFileDual::openNormWithCarriers(long numSets, bool getBothEnds){
